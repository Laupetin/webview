...
#ifndef WEBWINDOWED_DETAIL_PLATFORM_WINDOWS_THEME_IMPL_HPP
#define WEBWINDOWED_DETAIL_PLATFORM_WINDOWS_THEME_IMPL_HPP
...
{
  WEBWINDOWED_IMPL bool is_dark_theme_enabled()
  {
  ...
  WEBWINDOWED_IMPL void apply_window_theme(const HWND window)
  {
...
#endif // WEBWINDOWED_PLATFORM_WINDOWS_THEME_HPP
