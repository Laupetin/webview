...
#ifndef WEBWINDOWED_DETAIL_PLATFORM_WINDOWS_LOADER_IMPL_HPP
#define WEBWINDOWED_DETAIL_PLATFORM_WINDOWS_LOADER_IMPL_HPP
...
namespace webwindowed::detail
{
  ...
  {
    WEBWINDOWED_IMPL HRESULT loader::create_environment_with_options(const PCWSTR browser_dir,
    ...
    WEBWINDOWED_IMPL HRESULT loader::get_available_browser_version_string(const PCWSTR browser_dir, LPWSTR* version) const
    {
#if WEBVIEW_MSWEBVIEW2_EXPLICIT_LINK == 1
      if (m_lib.is_loaded())
      {
...
#if WEBVIEW_MSWEBVIEW2_BUILTIN_IMPL == 1
    WEBWINDOWED_IMPL
    loader::client_info_t::client_info_t(const bool found, std::wstring dll_path, std::wstring version, const webview2_runtime_type runtime_type)
        : found(found),
    ...
    WEBWINDOWED_IMPL HRESULT loader::create_environment_with_options_impl(const PCWSTR browser_dir,
                                                                          const PCWSTR user_data_dir,
                                                                          ICoreWebView2EnvironmentOptions* env_options,
                                                                          ICoreWebView2CreateCoreWebView2EnvironmentCompletedHandler* created_handler) const
    {
    ...
    WEBWINDOWED_IMPL HRESULT loader::get_available_browser_version_string_impl(const PCWSTR browser_dir, LPWSTR* version) const
    {
      if (!version)
        return -1;
    ...
    WEBWINDOWED_IMPL loader::client_info_t loader::find_available_client(const PCWSTR browser_dir) const
    {
      if (browser_dir)
    ...
    WEBWINDOWED_IMPL std::wstring loader::make_client_dll_path(const std::wstring& dir)
    {
      auto dll_path = dir;
      if (!dll_path.empty())
      {
...
#error WebView2 integration for this platform is not yet supported.
    ...
    WEBWINDOWED_IMPL loader::client_info_t
        loader::find_installed_client(const unsigned int min_api_version, const bool system, const std::wstring& release_channel)
    {
    ...
    WEBWINDOWED_IMPL loader::client_info_t loader::find_embedded_client(const unsigned int min_api_version, const std::wstring& dir)
    {
...
#endif // WEBWINDOWED_MSWEBVIEW2_BUILTIN_IMPL
  } // namespace mswebview2
} // namespace webwindowed::detail

#endif // defined(WEBWINDOWED_PLATFORM_WINDOWS) && defined(WEBWINDOWED_EDGE)
#endif // WEBWINDOWED_BACKENDS_WEBVIEW2_LOADER_HPP
