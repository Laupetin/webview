...
#ifndef WEBVIEW_PLUGIN_DETAIL_FAVICON_HANDLER_WINDOWS_HPP
#define WEBVIEW_PLUGIN_DETAIL_FAVICON_HANDLER_WINDOWS_HPP
...
namespace webview
{
  namespace detail
  {
    WEBVIEW_IMPL unique_favicon::unique_favicon(void* handle)
        : m_handle(handle)
    {
    }

    WEBVIEW_IMPL unique_favicon::~unique_favicon()
    {
      if (m_handle)
      {
    ...
    WEBVIEW_IMPL unique_favicon::unique_favicon(unique_favicon&& other) noexcept
        : m_handle(other.m_handle)
    {
      other.m_handle = nullptr;
    }

    WEBVIEW_IMPL unique_favicon& unique_favicon::operator=(unique_favicon&& other) noexcept
    {
      m_handle = other.m_handle;
      other.m_handle = nullptr;
      return *this;
