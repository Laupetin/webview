...
#ifndef WEBVIEW_PLUGIN_DETAIL_ASSET_HANDLER_WINDOWS_HPP
#define WEBVIEW_PLUGIN_DETAIL_ASSET_HANDLER_WINDOWS_HPP
...
namespace webview
{
  WEBVIEW_IMPL std::wstring headers_for_asset_name(const std::string& assetName, const size_t contentLength)
  {
  ...
  WEBVIEW_IMPL HRESULT HandleResourceRequested(ICoreWebView2_22* core22,
                                               IUnknown* args,
