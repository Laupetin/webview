...
#ifndef WEBVIEW_PLATFORM_LINUX_BACKEND_GTK_WEBKITGTK_IMPL_HPP
#define WEBVIEW_PLATFORM_LINUX_BACKEND_GTK_WEBKITGTK_IMPL_HPP
...
{
  WEBVIEW_IMPL gtk_webkit_engine::~gtk_webkit_engine()
  {
    if (m_window)
    {
  ...
  WEBVIEW_IMPL void gtk_webkit_engine::dispatch_impl(std::function<void()> f)
  {
  ...
  WEBVIEW_IMPL noresult gtk_webkit_engine::set_html_impl(const std::string& html)
  {
    webkit_web_view_load_html(WEBKIT_WEB_VIEW(m_webview), html.c_str(), nullptr);
    return {};
  }

  WEBVIEW_IMPL void gtk_webkit_engine::set_title_impl(const std::string& title)
  {
    gtk_window_set_title(GTK_WINDOW(m_window), title.c_str());
  }

  WEBVIEW_IMPL noresult gtk_webkit_engine::add_page_init_script(const std::string& js)
  {
  ...
  WEBVIEW_IMPL noresult gtk_webkit_engine::on_window_opened_impl()
  {
  ...
  WEBVIEW_IMPL noresult gtk_webkit_engine::window_settings()
  {
  ...
  WEBVIEW_IMPL void gtk_webkit_engine::run_event_loop_while(const std::function<bool()>& fn)
  {
    while (fn())
    {
